...
<body class="d-flex">
    ...
    <div class="bg-dark text-white p-3 vh-100" style="width: 220px;">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a href="services" class="nav-link text-white"><i class="bi bi-layers"></i> Services</a></li>
            <li class="nav-item"><a href="#" class="nav-link text-white"><i class="bi bi-file-post"></i> Posts</a></li>
            <li class="nav-item"><a href="#" class="nav-link text-white"><i class="bi bi-people"></i> Users</a></li>
            <li class="nav-item"><a href="#" class="nav-link text-white"><i class="bi bi-gear"></i> Carousel</a></li>
